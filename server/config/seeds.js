  ...
  const books = await Book.insertMany([
    ...
    },
    {
      ...
      },
      {
        ...
        year: "1968",
        description: "Ivan Sergeyevich Turgenev (Cyrillic: Иван Тургенев) was a novelist, poet, and dramatist, and now ranks as one of the towering figures of Russian literature.\nThis book features a collection of three of his works: Punin and Baburin, The Inn, and The watch.",
        image: "novellas-1968.jpeg",
        filter: filters[(2,4)]._id,
        price: 20,
        quantity: 5,
      },
      {
      ...
      },
      {
        ...
        author: "Alex Inkeles",
        year: "1971",
        description: "This collection of essays represents the results of more than twenty years of research by one of this country's foremost experts on Soviet sociology and psychology. Although Alex Inkeles covers a wide range of subjects, he has one primary purpose: to identify the main elements of the process of modernization in the Soviet social system.",
        image: "soviet-.jpeg",
        filter: filters[(2,3,7)]._id,
        price: 75,
        quantity: 1,
      },
      {
        ...
        year: "1971",
        description: "Lawrence L. Steinmetz, PhD, is an acclaimed author and speaker with degrees in business. Steinmetz developed a keen understanding of what it takes to operate businesses profitably and used this experience to write.",
      ...
      },
      {
        ...
        year: "1975",
        description: "This book has been written to acquaint readers with some of the enormous range of experiences associated with chronic illness.",
      ...
      },
      {
        ...
        year: "1975",
        description: "The human body, though an enormously complex system in its total function, can be seen to be made up of more elementary subsystems.",
        image: "phys-1975.jpg",
        filter: filters[(1,3,8)]._id,
        price: 135,
        quantity: 1,
